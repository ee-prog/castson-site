    ...
    <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 space-y-10 max-w-3xl">
        {posts.map((post) => (
          <article
            key={post.slug}
            className="group relative flex flex-col items-start rounded-2xl border border-white/5 bg-zinc-900/10 p-6 hover:bg-zinc-900/30 hover:border-emerald-500/20 transition-all duration-300"
          >
