      ...
      <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section className="space-y-4 fade-up-element delay-100">
            <h2 className="text-xl font-bold uppercase tracking-wider text-zinc-950 dark:text-white font-display">The Friction of Growth</h2>
          ...
          <section className="space-y-4 fade-up-element delay-150">
            <h2 className="text-xl font-bold uppercase tracking-wider text-zinc-950 dark:text-white font-display">Operational Perspective</h2>
            <p className="text-zinc-900 dark:text-zinc-200 leading-relaxed font-light text-sm">
        ...
        <div className="space-y-6 fade-up-element delay-300">
          <div className="rounded-sm border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/20 p-6 space-y-6 theme-transition">
            <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-950 dark:text-zinc-300 font-mono">[Quick Facts]</h3>
            
            <div className="space-y-4">
              <div className="flex gap-3">
                <Monitor className="h-5 w-5 text-emerald-600 dark:text-emerald-400 shrink-0" />
                <div>
                  <h4 className="text-xs font-bold text-zinc-950 dark:text-white uppercase tracking-wider">Identity Lanes</h4>
                  <p className="text-xs text-zinc-800 dark:text-zinc-400 mt-1 font-light">Systems Advisory, AI Operations Practice, Tech Integration</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-zinc-950 dark:text-white uppercase tracking-wider">Core Focus</h4>
                  <p className="text-xs text-zinc-800 dark:text-zinc-400 mt-1 font-light">TypeScript / Python / PostgreSQL / Supabase / AI Architecture & Agentic Workflows</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-zinc-950 dark:text-white uppercase tracking-wider">Location</h4>
                  <p className="text-xs text-zinc-800 dark:text-zinc-400 mt-1 font-light">Halifax Region, NS, Canada</p>
                </div>
              </div>
            </div>
