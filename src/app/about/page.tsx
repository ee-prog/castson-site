      ...
      <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section className="space-y-4 fade-up-element delay-100">
            ...
            <p className="text-zinc-800 dark:text-zinc-300 leading-relaxed font-light text-sm">
        ...
        <div className="space-y-6 fade-up-element delay-300">
          <div className="rounded-sm border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/20 p-6 space-y-6 theme-transition">
            <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-900 dark:text-zinc-350 font-mono">[Quick Facts]</h3>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-700 dark:text-zinc-400 mt-1 font-light">Systems Advisory, AI Operations Practice, Tech Integration</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-700 dark:text-zinc-400 mt-1 font-light">TypeScript / Python / PostgreSQL / Supabase / AI Architecture & Agentic Workflows</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-700 dark:text-zinc-400 mt-1 font-light">Halifax Region, NS, Canada</p>
                </div>
              </div>
            </div>
